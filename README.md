...
## **3** - End to End App Investment Analysis using PostgreSQL in a Jupyter Notebook, through specialized Python libraries, in which other Python libraries are showcased to improve the analysis quality.
...
5. **Visualizations**  
   We utilized various dashboard visualizations from Plotly, a Python Library, such as stacked bar charts, grouped bar charts, and heat maps, some enhanced with labels. Additionally, we employed a Python Bubble chart visualization for a specific insight.
...
The codes for this project above can be verified on my [Jupyter Noteboook](https://github.com/edy-dos-santos/myportfolio/blob/main/projects/App%20Apple%20Store%20Analysis/AppleStore_Analysis__V0.ipynb) 
